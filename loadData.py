...
#API key for querying Quandl. Obtaining API Key lets you make more than 50 API calls in a day
quandl.ApiConfig.api_key='Muh49uztNE7P3xysAy_U'
...
def nifty_50_list():
    ...
    tickers.remove('VEDL')#Removing it as the data is not present from 2012
    tickers.remove('UPL')#Removing it as the data is not present from 2012
    tickers.remove('IBULHSGFIN')#Removing it as the data is not present from 2012
    return tickers
